...
public class kalkulatBMI {
    public static void main(String[] args) throws Exception {
        Scanner bbm = new Scanner(System.in);
        ...
        System.out.println("masukan/pilihlah angka dibawah ini");
        ...
        jenis_kelamin = bbm.nextInt();
        System.out.print("Masukan Berat Badan: ");
        berat = bbm.nextFloat();
        System.out.print("Masukan Tinggi Badan: ");
        tinggi = bbm .nextFloat();
        meter = tinggi / 100;
